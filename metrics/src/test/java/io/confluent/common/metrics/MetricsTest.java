...
public class MetricsTest {
  ...
  Metrics
      metrics =
      new Metrics(new MetricConfig(), Arrays.asList((MetricsReporter) new JmxReporter()), time);
  ...
  public void testSimpleStats() throws Exception {
    ...
    s.add(new Percentiles(100, -100, 100, Percentiles.BucketSizing.CONSTANT,
  ...
  public void testOldDataHasNoEffect() {
    ...
    MetricConfig
        config =
        new MetricConfig().timeWindow(windowMs, TimeUnit.MILLISECONDS).samples(samples);
