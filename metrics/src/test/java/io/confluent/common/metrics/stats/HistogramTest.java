...
public class HistogramTest {
  ...
  public static void main(String[] args) {
    ...
    for (Histogram.BinScheme scheme : Arrays
        .asList(new Histogram.ConstantBinScheme(1000, -100, 100),
                new Histogram.ConstantBinScheme(100, -100, 100),
  ...
  public void testConstantBinScheme() {
    ...
    assertEquals("A value below the lower bound should map to the first bin", 0,
                 scheme.toBin(-5.01));
