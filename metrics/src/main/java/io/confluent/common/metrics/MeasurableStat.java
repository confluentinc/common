...
/**
 * A MeasurableStat is a {@link Stat} that is also {@link Measurable} (i.e. can produce a single
 * floating point value). This is the interface used for most of the simple statistics such as
